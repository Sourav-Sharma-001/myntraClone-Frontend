...
export default function bottomPage() {
  return (
    <>
      <div className='w-[80%] h-[250px] flex place-self-center place-content-center place-items-center mt-10 max-sm:h-[100px]'>
      ...
      <div className='w-[80%] place-self-center'>
        <div className='max-sm:grid max-sm:grid-cols-2 mt-9 flex justify-center'>
      ...
      <div className='w-[65%] place-self-center'>
        ...
        <div className='flex justify-between my-7 max-sm:grid max-sm:grid-cols-1 max-sm:gap-3'>
